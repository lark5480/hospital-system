...
public class ReportController {
    ...
    public ResponseEntity<List<Report>> listByVisit(@RequestParam Long visitId) {
        return ResponseEntity.ok(reportService.listByVisit(visitId));
    }

    @GetMapping("/api/reports/type/{type}")
    public ResponseEntity<List<ReportDetail>> listByType(@PathVariable String type) {
    ...
    public ResponseEntity<ReportDetail> get(@PathVariable Long id) {
    ...
    public ResponseEntity<Report> publish(@PathVariable Long id) {
        return ResponseEntity.ok(reportService.publish(id));
    }

    @GetMapping("/api/reports/patient/{patientId}")
    public ResponseEntity<List<ReportDetail>> listByPatient(@PathVariable Long patientId) {
